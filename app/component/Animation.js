    ...
    <div className="flex flex-col gap-10 overflow-x-hidden justify-center text-center">
      ...
      >
        <div className="flex flex-col justify-center text-center">
          ...
          >
            Today it was a very hard day at scholl but also very fun one. First
            I got my grades back from psyhology and I got a 2 50% to be exact.
            And I had this luck that she will sum it to 4 as the end Grade
          </motion.p>
          <motion.p
            className="text-slate-800 text-center  text-2xl tracking-wide"
            animate={mainControls}
